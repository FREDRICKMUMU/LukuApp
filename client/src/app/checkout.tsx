        ...
        <SafeAreaView className='flex-1 bg-surface' edges={["top"]}>
            ...
            <ScrollView className='flex-1 px-4 mt-4'>
                ...
                <TouchableOpacity
                    ...
                    className={`bg-white p-4 rounded-xl mb-4 shadow-sm flex-row items-center border-2 ${paymentMethod === 'pesapal' ? 'border-primary' : 'border-transparent'}`}
                >
                    ...
                    {paymentMethod === 'pesapal' && <Ionicons name='checkmark-circle' size={24} color={COLORS.primary} />}
                </TouchableOpacity>
            </ScrollView>
